...
# last_analyze
$C -s last_analyze --status-file /tmp/check_pgactivity.data -h $HOST -w 30m -c 1h30m || exit 1

# last_vacuum
$C -s last_vacuum --status-file /tmp/check_pgactivity.data  -h $HOST -w 30m -c 1h30m || exit 1
